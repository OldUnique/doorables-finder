    ...
    <main className="collectionPage">
      ...
      <div className="shell">
        ...
        <section className="hookPanel">
          ...
          <div className="hookTile">
            <div className="hookTitle">Everything from Supabase loads now ✅</div>
            <div className="hookText">This page loads Doorables in batches instead of stopping at one range, so new Supabase rows can show in the collection.</div>
          </div>
        </section>
